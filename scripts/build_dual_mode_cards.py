...
Left side: Siddharth's ASCII portrait (25 rows x 36 cols, font-size 16px).
Right side: Resume details (25 rows, font-size 16px, all lines <= 56 chars).
No overflow, perfectly aligned.
"""
...
def make_svg(mode="dark"):
    ...
    # Exactly 25 rows for ASCII art at y = 30, 50, ..., 510 (step 20)
    ascii_tspans = []
    for i, row in enumerate(ASCII_25_ROWS):
        y = 30 + i * 20
        row_esc = html.escape(row)
        ascii_tspans.append(f'<tspan x="18" y="{y}">{row_esc}</tspan>')

    # Exactly 25 rows for Info Card at y = 30, 50, ..., 510 (step 20)
    # Keeping all lines <= 56 characters so no overflow past 985px
    info_lines = [
        # y=30
        ...
        # y=90
        (90, '<tspan x="390" y="90" class="cc">. </tspan><tspan class="key">Host</tspan>:<tspan class="cc"> .................... </tspan><tspan class="value">Amity University, BLR</tspan>'),
        # y=110
        (110, '<tspan x="390" y="110" class="cc">. </tspan><tspan class="key">Kernel</tspan>:<tspan class="cc"> .................. </tspan><tspan class="value">Full Stack &amp; AI Developer</tspan>'),
        # y=130
        ...
        # y=170
        (170, '<tspan x="390" y="170" class="cc">. </tspan><tspan class="key">Languages</tspan>.<tspan class="key">Programming</tspan>:<tspan class="cc"> ... </tspan><tspan class="value">TypeScript, Python, JS, C</tspan>'),
        # y=190
        (190, '<tspan x="390" y="190" class="cc">. </tspan><tspan class="key">Languages</tspan>.<tspan class="key">Web</tspan>:<tspan class="cc"> ........... </tspan><tspan class="value">React, Node, Express, FastAPI</tspan>'),
        # y=210
        (210, '<tspan x="390" y="210" class="cc">. </tspan><tspan class="key">Languages</tspan>.<tspan class="key">Data</tspan>:<tspan class="cc"> .......... </tspan><tspan class="value">MongoDB, Postgres, SQL, Docker</tspan>'),
        # y=230
        (230, '<tspan x="390" y="230" class="cc">. </tspan>'),
        # y=250
        (250, '<tspan x="390" y="250" class="cc">. </tspan><tspan class="key">Experience</tspan>.<tspan class="key">Intern</tspan>:<tspan class="cc"> ....... </tspan><tspan class="value">Web Dev Intern @ Infotact</tspan>'),
        # y=270
        (270, '<tspan x="390" y="270" class="cc">. </tspan><tspan class="key">Projects</tspan>.<tspan class="key">Featured</tspan>:<tspan class="cc"> ....... </tspan><tspan class="value">CORTEXA, Telemedicine EHR</tspan>'),
        # y=290
        (290, '<tspan x="390" y="290" class="cc">. </tspan><tspan class="key">Certifications</tspan>:<tspan class="cc"> .......... </tspan><tspan class="value">Oracle OCI 2025, Google Cert</tspan>'),
        # y=310
        ...
        # y=410
        (410, '<tspan x="390" y="410" class="cc">. </tspan><tspan class="key">Education</tspan>:<tspan class="cc"> ............... </tspan><tspan class="value">MCA (Amity) · B.Sc Physics</tspan>'),
        # y=430
        ...
        # y=510
        (510, '<tspan x="390" y="510" class="cc">. </tspan><tspan class="key">Lines of Code</tspan>:<tspan class="cc"> ..... </tspan><tspan class="value">185,420</tspan> ( <tspan class="addColor">165,240</tspan><tspan class="addColor">++</tspan>, <tspan class="delColor">20,180</tspan><tspan class="delColor">--</tspan> )')
    ]
...
<text x="18" y="30" fill="{text_color}" class="ascii">
{ascii_tspans_str}
</text>
